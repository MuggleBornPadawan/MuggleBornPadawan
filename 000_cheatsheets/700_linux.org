...
** zsh
- nano ~/.zshrc
- export PATH="/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Library/Apple/usr/bin:/Users/ganeshrajendran/.local/pipx/venvs/flask:/opt/homebrew/bin:/usr/bin/python3"
- source ~/.zshrc
** packages
