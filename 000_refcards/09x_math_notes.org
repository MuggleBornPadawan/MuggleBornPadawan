...
- [[#math][math]]
  ...
  - [[#calculus-1][calculus]]
    ...
    - [[#approach-to-integration][approach to integration]]
    - [[#types][types]]
    - [[#levels][levels]]
  - [[#most-important-theorems-in-math][most important theorems in math]]
  - [[#engineering-math][engineering math]]
  - [[#symbollic-notations][symbollic notations]]
    - [[#quantifiers-and-sets][Quantifiers and Sets:]]
    - [[#logical-operators][Logical Operators:]]
    - [[#numbers-and-constants][Numbers and Constants:]]
    - [[#operations-and-relations][Operations and Relations:]]
    - [[#geometric-symbols][Geometric Symbols:]]
    - [[#reasoning-and-statements][Reasoning and Statements:]]
...
** difficulty levels
a ranked list of fields of math, in order of difficulty to master and understand. of course, difficulty is highly subjective and depends on your background, interests, and how deeply you go. the fields are deeply interconnected, basic topics feed into advanced branches, and areas like number theory span multiple levels.
*** arithmetic
- difficulty: low
