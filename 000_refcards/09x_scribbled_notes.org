...
- [[#scribbled-notes][scribbled notes]]
  - [[#learning-order][learning order]]
  - [[#sre-roadmap][sre roadmap]]
  - [[#postgresql-database-types-and-equivalent][postgresql database types and equivalent]]
  - [[#backend-exercises][backend exercises]]
  - [[#patterns][patterns]]
  - [[#cache][cache]]
  - [[#leetcode-problems---data-structure-and-algorithms][leetcode problems - data structure and algorithms]]
  - [[#high-performers][high performers]]
  - [[#diagrams-as-code][diagrams as code]]
  - [[#race-conditions][race conditions]]
  - [[#ai-automation-vs-ai-agent][ai automation vs ai agent]]
  - [[#chain-of-thought-cot-vs-tree-of-thought-tot-vs-graph-of-thought-got][chain of thought (cot) vs tree of thought (tot) vs graph of thought (got)]]
  - [[#new-stack][new stack]]
  - [[#software-engineering-laws][software engineering laws]]
  - [[#russ-olsen---goto18---functional-programming][russ olsen - goto18 - functional programming]]
  - [[#richard-feldman---clojuture-2019---why-isnt-functional-programs-the-norm][Richard Feldman - clojuture 2019 - Why isn't functional programs the norm?]]
  - [[#numerical-linear-algebra][numerical linear algebra]]
  - [[#data-fundamentals][data fundamentals]]
  - [[#data-science][data science]]
  - [[#data-tools-and-languages][data tools and languages]]
  - [[#ai-vs-augmented-intelligence][AI vs augmented intelligence]]
  - [[#natural-language-processing][natural language processing]]
  - [[#ai-ethics][ai ethics]]
  - [[#skills][skills]]
  - [[#ai-general-stuff][ai general stuff]]
...
- [[#resources][resources]]
  ...
  - [[#portals][portals]]
  - [[#journals-news-and-blogs][journals, news and blogs]]
  - [[#free-learning][free learning]]
  - [[#machine-learning][machine learning]]
  - [[#future-forward-technologies][future forward technologies]]
