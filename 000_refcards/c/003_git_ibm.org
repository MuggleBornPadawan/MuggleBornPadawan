...
| git branch       | to create a new branch; git branch (lists branches)                                 | git branch -d <branch_name>; delete the branch                                   |
...
| git fetch        | to update local repo from remote repo                                               |                                                                                  |
| git pull         | to update local repo and merge (fetch + merge) to branch                            |                                                                                  |
