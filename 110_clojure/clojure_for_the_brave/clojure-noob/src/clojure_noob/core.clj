...
(defn -main
  ...
  (defn crash-course-demo
    ...
    (defn control-flow-demo
      "basic control flow operators: if, do, when nil, true, false, truthiness, equality, and boolean expressions"
      []
      (println (if true 1 2))
    ...
    (defn closures-demo
      "closures are returned functions which can be used by other functions"
      []
      (defn inc-maker
