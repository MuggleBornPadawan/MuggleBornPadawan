...
MODELS=(
    ...
    "baidu/ernie-4.5-21b-a3b-thinking:floor"
    "deepseek/deepseek-r1-0528-qwen3-8b:floor"
    ...
    "ibm-granite/granite-4.0-h-micro:floor"
    "inclusionai/ling-1t:floor"
    "liquid/lfm-7b:floor"
    ...
    "nvidia/llama-3.3-nemotron-super-49b-v1.5:floor"
    ...
    "qwen/qwen3-vl-8b-instruct:floor"
    "qwen/qwen3-8b:floor"
