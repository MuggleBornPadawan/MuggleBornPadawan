...
for person_name in "${names[@]}"; do
    ...
    api_request_prompt="Give me one notable quote from ${person_name} and a brief summary of their notable contributions. Format this as: Quote: [The Quote] Contributions: [The Contributions Summary]"
