...
;; The parameters are set for highly creative and "wild" answers:
...
(setq gptel-backend
      (gptel-make-ollama "Ollama-Wild"
        :host "localhost:11434"
        :stream t
        :models '("llama3.2")
        :request-params '(:options (:temperature 1.4
                                    :top_p 0.99
                                    :top_k 120))))
...
(message "Ollama-Wild backend initialized for gptel (llama3.2) with wild parameters!")
