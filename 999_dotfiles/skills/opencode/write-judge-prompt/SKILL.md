...
description: "Design binary Pass/Fail LLM evaluators for specific failure modes. Use when writing an LLM judge, testing AI output quality, or evaluating subjective criteria. Binary checks, code-first, TypeSafe AI (Jev) compatible."
---

# Write LLM Judge Prompt
