...
description: Audit, design, or implement telemetry in open-source projects. Use when adding metrics, reviewing network tracking, or enforcing privacy standards.
---
