...
name: pi-sync
description: >-
  Syncs, audits, and imports memories (AGENTS.md/GEMINI.md), skills, and prompt workflows from the Pi coding harness (~/.pi/agent) into Antigravity Gemini. Validates relevance, eliminates overlaps, and rewrites configurations to comply with Antigravity guidelines.
---

# Pi Coding Harness Sync & Importer
