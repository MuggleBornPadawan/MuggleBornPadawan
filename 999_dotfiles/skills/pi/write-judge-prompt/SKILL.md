...
description: "Design binary Pass/Fail LLM evaluators for specific failure modes. Use when writing an LLM judge, testing AI output quality, or evaluating subjective criteria. Lean Pi adapted: binary checks, code-first, TypeSafe AI (Jev) compatible."
---
